...
if("TRUE" STREQUAL "TRUE")
  set(rtk_SOURCE_PREFIX /home/hongxu/agbot_deploy/src/gps/src/rtk)
  set(rtk_DEVEL_PREFIX /home/hongxu/agbot_deploy/devel/.private/rtk)
  set(rtk_INSTALL_PREFIX "")
  set(rtk_PREFIX ${rtk_DEVEL_PREFIX})
else()
  set(rtk_SOURCE_PREFIX "")
  set(rtk_DEVEL_PREFIX "")
  set(rtk_INSTALL_PREFIX /home/hongxu/agbot_deploy/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hongxu/agbot_deploy/src/gps/src/rtk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hongxu/agbot_deploy/devel/.private/rtk/lib;/home/hongxu/agbot_deploy/devel/lib;/home/hongxu/agbot_camera/devel/lib;/opt/ros/kinetic/lib)
