...
if("TRUE" STREQUAL "TRUE")
  set(rear_view_SOURCE_PREFIX /home/agbot/agbot_deploy/src/rear_view)
  set(rear_view_DEVEL_PREFIX /home/agbot/agbot_deploy/devel/.private/rear_view)
  ...
  set(rear_view_INSTALL_PREFIX /home/agbot/agbot_deploy/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rear_view' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agbot/agbot_deploy/src/rear_view/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/agbot/agbot_deploy/devel/.private/rear_view/lib;/home/agbot/agbot_deploy/devel/lib;/opt/ros/kinetic/lib)
